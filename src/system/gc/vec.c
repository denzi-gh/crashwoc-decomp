...
void C_VECNormalize(const Vec* src, Vec* unit) {
    ...
    ASSERTMSGLINE(309, src, "VECNormalize():  NULL VecPtr 'src' ");
    ASSERTMSGLINE(310, unit, "VECNormalize():  NULL VecPtr 'unit' ");

    mag = (src->z * src->z) + ((src->x * src->x) + (src->y * src->y));
    ASSERTMSGLINE(315, 0.0f != mag, "VECNormalize():  zero magnitude vector ");
...
f32 C_VECDotProduct(const Vec* a, const Vec* b) {
    ...
    ASSERTMSGLINE(530, a, "VECDotProduct():  NULL VecPtr 'a' ");
    ASSERTMSGLINE(531, b, "VECDotProduct():  NULL VecPtr 'b' ");
...
void C_VECCrossProduct(const Vec* a, const Vec* b, Vec* axb) {
    ...
    ASSERTMSGLINE(592, a, "VECCrossProduct():  NULL VecPtr 'a' ");
    ASSERTMSGLINE(593, b, "VECCrossProduct():  NULL VecPtr 'b' ");
    ASSERTMSGLINE(594, axb, "VECCrossProduct():  NULL VecPtr 'axb' ");
